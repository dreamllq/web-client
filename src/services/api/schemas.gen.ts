...
export const BiViewMetaGetResponseSchema = {
    type: 'object',
    properties: {
        code: {
            type: 'number'
...
export const BiViewMetaPaginatePageSchema = {
    type: 'object',
    properties: {
        list: {
            type: 'array',
...
export const BiViewMetaPaginateResponseSchema = {
    type: 'object',
    properties: {
        code: {
            type: 'number'
        ...
        data: {
            '$ref': '#/components/schemas/BiViewMetaPaginatePage'
        }
    },
    required: ['code', 'data']
} as const;
