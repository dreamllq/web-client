...
const editDefaultData:{title: string, content: string, sectionId: string, images: string[]} = reactive({
  title: '',
  content: '',
  sectionId: '',
  images: []
...
const edit = async (data:{ id:string }) => {
  ...
  editDefaultData.content = res.data?.data.content;
  editDefaultData.sectionId = res.data?.data.section.id;
