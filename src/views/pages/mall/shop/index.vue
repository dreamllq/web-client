...
import { ref } from 'vue';
import BizFilter from '@/views/components/mall/shop/filter.vue';
import BizTable from '@/views/components/mall/shop/table.vue';
import BizAddDialog from '@/views/components/mall/shop/add-dialog.vue';

const bizTableRef = ref();
const bizAdd = ref();

const onSearch = (filter:{name:string}) => {
